...
{
private:
    Universidade* pUniversidadeFiliado;    //ponteiro que associa departamento filiado
    Departamento* pDepartamentoFiliado;   //ponteiro que associa universidade filiada
