...
{
    std::cout << nomeP << "  trabalha na " << pUniversidadeFiliado->getNome() << " no departamento " << pDepartamentoFiliado->getNomeDpto() << std::endl;
}

void Pessoa::OndeEstuda()
{
    std::cout << nomeP << "estuda na " << pUniversidadeFiliado->getNome() << std::endl;
}
*/
